...
describe('Tester', function() {
  ...
  describe('BeforeEach', function() {
    it("execute callbacks for examples within describe block", function() {
      var a = 0;
      var total = 0;
      Tester.describe("describeOne", function() {
        Tester.beforeEach(function() {
          a = 1;
        });
        Tester.it("one", function() {
          total += a;
          a = 0;
        });
        Tester.it("two", function() {
          total += a;
          a = 0;
        });
      });
      Tester.describe("describeTwo", function() {
        Tester.it("three", function() {
          total += a;
          a = 0;
        });
      });
